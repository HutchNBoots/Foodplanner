      ...
      meals: [
        {
          ...
          servingsAdults: 2,
          servingsKids: 0,
          ingredients: [{ name: "chicken", quantity: 400, unit: "g", aisle: "Meat & fish", cholesterolLowering: false }],
          method: ["Cook it."],
          ...
          meals: [
            {
              ...
              servingsAdults: 0,
              servingsKids: 2,
              ingredients: [{ name: "pasta", quantity: 200, unit: "g", aisle: "Store cupboard", cholesterolLowering: false }],
              method: ["Cook it."],
