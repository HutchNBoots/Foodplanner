...
${intake.lowerCholesterol ? "This week has a cholesterol-lowering focus: actively favour ingredients with recognised LDL-cholesterol-lowering properties (oats, oily fish, nuts, seeds, legumes/beans/lentils, olive oil, soluble-fibre fruit/veg, soy) wherever they fit the meal, AND actively favour lower-saturated-fat choices (low-fat/fat-free dairy such as low-fat yoghurt or skimmed milk instead of full-fat versions, lean cuts with visible fat trimmed, skinless poultry, unsaturated oils like olive oil instead of butter) wherever they fit the meal - without abandoning the dish styles/proteins/effort requested above." : ""}
